...
Confirmed `openssh-server` was installed and active:
...
| `04-expanded-5712-alert.png` | Expanded detail view of the rule 5712 brute-force correlation alert, first-portion |
| `05-expanded-5712-alert.png` | Expanded detail view of the rule 5712 brute-force correlation alert, second-portion |
